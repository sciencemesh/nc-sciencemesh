...
<section>
    <div class="viewcontainer section-sciencemesh">
        <div class="sciencemesh-settings-row">
            ...
            <input type="text" style="width: 65%;" name="sciencemesh_iop_url" id="sciencemesh_iop_url"
                   value="<?php echo $this->vars['sciencemeshIopUrl']; ?>">
        ...
        <div class="sciencemesh-settings-row">
            ...
            <input type="text" style="width: 77%;" id="sciencemesh_shared_secret"
                   value="<?php echo $this->vars['sciencemeshRevaSharedSecret']; ?>">
        </div>
