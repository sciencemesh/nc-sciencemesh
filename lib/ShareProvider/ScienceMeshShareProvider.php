...
//		$this->tokenHandler = $tokenHandler;
	...
	public function create(IShare $share) {
		 ...
		 */
		$alreadyShared = $this->getSharedWith($shareWith, IShare::TYPE_SCIENCEMESH, $share->getNode(), 1, 0);
...
*/
	...
	private function removeShareFromTableById($shareId) {
		...
		$qb->delete('share')
			...
			->andWhere($qb->expr()->eq('share_type', $qb->createNamedParameter(IShare::TYPE_SCIENCEMESH)));
		$qb->execute();
	...
	public function getSharesInFolder($userId, Folder $node, $reshares) {
		...
		$qb->select('*')
			...
			->andWhere(
				$qb->expr()->eq('share_type', $qb->createNamedParameter(IShare::TYPE_SCIENCEMESH))
			);
	...
	public function userDeleted($uid, $shareType) {
		...
		$qb->delete('share')
			->where($qb->expr()->eq('share_type', $qb->createNamedParameter(IShare::TYPE_SCIENCEMESH)))
	...
	public function getAllShares(): iterable {
		...
		$qb->select('*')
			->from('share')
			->where(
				$qb->expr()->eq('share_type', $qb->createNamedParameter(\OCP\Share\IShare::TYPE_SCIENCEMESH))
			);
